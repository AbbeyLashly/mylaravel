...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <title>AgroProjects | Register </title>
              ...
              <div class="col-sm-12 col-md-4 col-md-offset-4 ">
                <div class="panel panel-success">
                  <div class="panel-heading">
                    <h4 class=""><strong>AgroProjects</strong><small class="pull-right panel-hint">Register below</small></h4>
                  </div>
                  <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="Username">Password</label>
                        <input type="password" name="password-check" placeholder="Enter your Password" class="form-control">
                    </div>

                    <button type="button" name="button" class="btn btn-success"><a href="{{ route('register') }}">Register</a></button>
